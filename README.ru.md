...
![База Simagic, под которую настраивалось всё на этой странице: Alpha EVO 12 N.m при 55%, 600 градусов поворота, механические эффекты почти выключены](docs/img/wheel-settings-reference.png)
