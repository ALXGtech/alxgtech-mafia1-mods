...
> **Эта страница на одну ревизию отстаёт от английской.** Актуальная версия -
> [English](README.md); перевод обновляется.

# ALXGtech Mafia 1 Mods

Этот мод добавляет Mafia: The City of Lost Heaven (2002, **GOG v1.3 build 16073**) современную
обратную связь руля Direct Drive Force Feedback (проверено на Simagic Alpha EVO; должен подойти
любой руль с DirectInput), камеру от первого лица за рулём и H-шифтер - одна утилита ставит и
снимает всё это.
